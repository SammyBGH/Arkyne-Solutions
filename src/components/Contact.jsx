      ...
      <div className="container">
        ...
        <div className="contact-content">
          <div className="contact-info">
            <div className={`info-grid ${isVisible ? 'animate-fade-in-left' : ''}`}>
            ...
            <div className={`social-links ${isVisible ? 'animate-fade-in-left' : ''}`}>
              <h4>Follow Us</h4>
          ...
          <div className="contact-form-container">
            <form 
              className={`contact-form ${isVisible ? 'animate-fade-in-right' : ''}`}
